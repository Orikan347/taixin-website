(function (root, factory) {
  ...
  function buildRecommendationReply(state) {
    ...
    return `太好了，這代表你的優勢其實很清楚。我直接把最適合你的三堂課先列給你：\n\n${lines}\n\n照這個順序補，你會更快把優勢發揮出來。目前已確認的場次與金額我整理在頁面上；吉隆坡場金額由顧問依最新公告回覆，複訓費用是 NT$ 3,200。`;
  }
