(function (root, factory) {
  ...
  const LIFE_TALENTS = {
    1: [['主導開路', '你適合先幫客戶看見方向。'], ['帶頭行動', '你能把想法轉成第一步。'], ['明確決策', '你要練習把主導力用在引導，而不是急推。']],
    2: [['感受敏銳', '你容易察覺客戶的猶豫。'], ['關係協調', '你適合用溫和方式拉近距離。'], ['陪伴說服', '你能讓客戶覺得被理解。']],
    3: [['表達有感', '你適合用故事和畫面說明價值。'], ['互動自然', '你容易讓客戶願意接話。'], ['氣氛帶動', '你能把冷場變成交流。']],
    4: [['流程落地', '你適合把銷售變成固定步驟。'], ['穩定累積', '你能靠紀錄和紀律慢慢做出成果。'], ['執行可靠', '你讓客戶覺得事情交給你很安心。']],
    5: [['開發彈性', '你適合找新機會和新名單。'], ['反應快速', '你能很快接住客戶變化。'], ['行動能量', '你要用系統接住很多機會。']],
    6: [['服務溫度', '你能讓客戶感覺被照顧。'], ['責任感強', '你適合做長期信任型銷售。'], ['口碑累積', '你的成交常來自關係和服務品質。']],
    7: [['洞察很深', '你適合看出客戶沒講出口的顧慮。'], ['專業說服', '你能用觀察和判斷建立信任。'], ['安靜影響', '你不用很吵，也能讓人覺得你懂。']],
    8: [['成果敏感', '你很適合談價值交換和投資回報。'], ['資源整合', '你能幫客戶看見方案背後的效益。'], ['成交魄力', '你要練習把價值講清楚後自然推進。']],
    9: [['格局視角', '你容易看見客戶更大的目標。'], ['整合優勢', '你能把感受、需求和方案整理在一起。'], ['影響他人', '你適合把個人經驗變成能幫更多人的方法。']]
  };

  const QUOTES = [
    '銷售力不從心，因為從沒遇過李泰欣。',
    '讓客戶有感，價值就會被看見。',
    '不是你不努力，是你需要一套能累積成果的方法。',
    '成交不是逼人，是幫客戶看懂下一步。'
  ];
  ...
  const BRANCH_DETAILS = [
    ...
    },
    {
      ...
      branch: 'expression',
      reply: '要講得有感，就先不要從產品功能開始。先講客戶現在的問題，再講用了之後會變成什麼樣子，最後才補你的方法。這就是 BAF 的精神：先講好處，再講優勢，最後講功能。'
    },
    {
  ...
  function buildProfileSpec(state) {
    ...
    if (activeLine) {
      lifeTalents[2] = {
        ...
        insight: `你的生日裡有「${activeLine.name}」，代表你適合把不同資訊整理成一條路。`,
        strategy: '用在銷售上，就是幫客戶把問題、選擇和下一步串起來。'
      };
    }
    const quote = QUOTES[(lifeNumber + disc.primary.charCodeAt(0)) % QUOTES.length];
    return {
