(function (root, factory) {
  ...
  function buildSystemPrompt(state, deterministicResult, userMessage) {
    ...
    return [
      ...
      '- 當對話蒐集狀態 can_build_report=true，phase 才能設為 profile_ready，產出報告，reply 要自然說：我把你的銷售天賦整理成表格，已經放在底下給你囉。你覺得有準嗎？也可以繼續了解怎麼做，讓自己成長更快。',
  ...
  function isGenericDiscoveryQuestion(reply) {
    return /(主要賣什麼|賣的是什麼|哪一種客戶|哪種客戶|客戶通常|客戶是誰|會買單的是|最想讓自己哪個地方更強|最想讓這份報告幫你看見哪一個銷售優勢)/.test(reply);
  }
